...
%Load data from aritifical data
...
max_deg = 30;
[fits_train, fits_test, mses_train, mses_test, best_deg] = find_best_degree(xtrain, ytrain, xtest, ytest, max_deg);
...
for i = 1:1:2 
    [fits_train, fits_test, mses_train, mses_test, best_k] = find_best_Ink(xtrain, ytrain, xtest, ytest, best_deg(i), min_k, max_k);
